...
When there are 68 teams in the tournament, there are 68x67/2=2,278 predictions to make for that year, so a Stage 1 submission file will have 2,278x5=11,390 data rows.
